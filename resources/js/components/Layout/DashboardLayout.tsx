...
export default function DashboardLayout({children}) {
  ...
  return (
    <div className="dark:text-white text-gray-800 h-screen flex overflow-hidden text-sm">
      <Sidebar mobileOpenedSidebar={mobileOpenedSidebar} setMobileOpenedSidebar={setMobileOpenedSidebar}/>
      <div className="flex-grow overflow-hidden h-full flex flex-col">
        <Topbar mobileOpenedSidebar={mobileOpenedSidebar} setMobileOpenedSidebar={setMobileOpenedSidebar}/>
...
function Topbar({mobileOpenedSidebar, setMobileOpenedSidebar}) {
...
function Sidebar({mobileOpenedSidebar, setMobileOpenedSidebar}) {
  const [openedSidebar, _setOpenedSidebar] = useState(initialOpenedSidebar);

  const setOpenedSidebar = (val: boolean) => {
  ...
  return <div className={sidebarClass}>
    ...
    <div className="flex mx-auto flex-grow mt-4 flex-col text-gray-400 space-y-2 p-3 w-full">
      ...
      <HasRole roles={['tomoru', 'worker']}>
        <SidebarNavLink to="/requests" activeOn="/requests/[^kanban]" onClick={() => setMobileOpenedSidebar(false)}>
      ...
      <HasRole roles={['manager']}>
        <SidebarNavLink to="/requests/kanban" activeOn="/requests/.*" onClick={() => setMobileOpenedSidebar(false)}>
...
function SidebarNavLink({
                          className = '', to, children, activeOn, onClick = () => {
  }
                        }) {
