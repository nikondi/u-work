    ...
    return <div className={sidebarClass}>
        ...
        <div className="flex mx-auto flex-grow mt-4 flex-col text-gray-400 space-y-2 p-3 w-full">
            ...
            <HasRole roles={['tomoru', 'worker']}>
                <SidebarNavLink to="/requests" activeOn="/requests/.*" onClick={() => setMobileOpenedSidebar(false)}>
...
function SidebarNavLink({className = '', to, children, activeOn, onClick = () => {}}) {
